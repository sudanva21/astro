...
// The horoscope API is mounted at /calc prefix on the backend
const base = ((import.meta as any).env?.VITE_API_BASE as string) || 'http://127.0.0.1:8000';
const calcBase = base + '/calc';
console.log('[API Config] Base URL:', calcBase);
console.log('[API Config] ENV vars:', (import.meta as any).env);
